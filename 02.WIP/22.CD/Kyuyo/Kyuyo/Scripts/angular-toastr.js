        ...
        function _notify(map) {
            ...
            function createScope(toast, map, options) {
                if (options.allowHtml) {
                    ...
                    toast.scope.messages = [];
                    if (angular.isArray(map.message)) {
                        toast.scope.messages = map.message;
                    } else if (angular.isString(map.message)) {
                        toast.scope.messages.push(map.message)
                    }
