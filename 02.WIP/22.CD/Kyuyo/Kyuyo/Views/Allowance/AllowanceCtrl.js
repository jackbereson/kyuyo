(function (app) {
    ...
    AllowanceCtrl.$inject = ['$scope', '$rootScope', '$state', '$filter', '$messages', '$strings','$values', 'apiService'];
    function AllowanceCtrl($scope, $rootScope, $state, $filter, $messages, $strings, $values, apiService) {
